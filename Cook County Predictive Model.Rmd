...
high_cor_h <- high_cor_h[high_cor_h[, 1] < high_cor_h[, 2], ]  # Exclude duplicates
...
x_train <- model.matrix(sale_price ~ . - 1, data = train_data)  # Creating model matrix, excluding intercept
